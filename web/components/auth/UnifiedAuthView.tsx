    ...
    <div className="w-full grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-14 items-center">
      ...
      <div className="lg:col-span-5 w-full flex justify-center lg:justify-end relative z-20">
        <div className="w-full max-w-md bg-white rounded-2xl border border-black/[0.08] p-7 sm:p-9 shadow-[0_16px_40px_-8px_rgba(0,0,0,0.06),0_1px_3px_rgba(0,0,0,0.04)] relative">
          ...
          {/* Guest Login Option — Mobile Parity */}
          <div className="mt-3">
            <button
              type="button"
              onClick={loginAsGuest}
              className="w-full flex items-center justify-center gap-2 py-2 px-3 bg-zinc-50/90 hover:bg-zinc-100 border border-dashed border-zinc-300 hover:border-zinc-400 rounded-xl text-xs font-semibold text-zinc-700 transition-all active:scale-[0.98]"
            >
              <UserIcon className="w-3.5 h-3.5 text-zinc-500" />
              <span>Continue as Guest</span>
              <span className="text-[10px] font-mono text-zinc-400 font-normal">(Instant Access)</span>
            </button>
          </div>
