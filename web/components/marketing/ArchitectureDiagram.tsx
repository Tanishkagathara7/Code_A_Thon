          ...
          return (
            <button
              ...
              className={`topology-node-btn p-5 rounded-2xl text-left transition-all duration-200 border relative overflow-hidden cursor-pointer group flex flex-col justify-between min-h-[145px] ${
                isSelected
                  ? 'bg-white border-zinc-950 shadow-lg shadow-black/[0.12] ring-2 ring-zinc-950/20'
            ...
            >
              ...
              <div>
                <div className="flex items-center justify-between mb-3">
                  ...
                  <div className="flex items-center gap-1.5">
                    {isSelected ? (
                      <span className="text-[10px] font-bold font-mono text-zinc-950 bg-zinc-100 px-1.5 py-0.5 rounded border border-zinc-300 flex items-center gap-1">
              ...
              <div className="pt-2.5 mt-2 border-t border-zinc-100 flex items-center justify-between text-[11px] text-zinc-400">
                ...
                <span className={`transition-transform duration-200 ${isSelected ? 'text-zinc-950 translate-x-0.5' : 'group-hover:translate-x-0.5'}`}>
                  &rarr;
                </span>
              </div>
            </button>
